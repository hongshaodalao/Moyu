...
const ITEMS = [
  ...
  // --- Combat gear (new) ---
  {
    ...
    slot: 'weapon',
    name: '小叉子长枪（重击）',
    desc: '高伤害路线：出手不快，但每下都更疼。',
    price: 60,
    incomeBonus: 0,
    combatBonus: { atk: 10, atkSpeedPct: -0.12 },
  ...
  },
  {
    ...
    slot: 'weapon',
    name: '双匕贝壳刃（疾速）',
    desc: '高攻速路线：单次较轻，但持续输出稳定。',
    price: 170,
    incomeBonus: 0,
    combatBonus: { atk: 4, atkSpeedPct: 0.55 },
  ...
  },
  {
    ...
    slot: 'weapon',
    name: '针刺三叉戟（穿甲）',
    desc: '折中路线：攻击提升 + 少量防御加成，稳。',
    price: 950,
    incomeBonus: 0,
    combatBonus: { atk: 14, def: 1 },
    sceneEffect: { type: 'prop', key: 'fork' },
  },
  {
    id: 'shell-armor',
